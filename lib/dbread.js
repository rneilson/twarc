...
class DBReader {
	...
	keys (db, opts, txn) {
		return this[_iter]('keys', db, opts.start, opts.end, opts.count, opts.reverse, txn);
	}

	values (db, opts, txn) {
		return this[_iter]('values', db, opts.start, opts.end, opts.count, opts.reverse, txn);
	}

	entries (db, opts, txn) {
		return this[_iter]('entries', db, opts.start, opts.end, opts.count, opts.reverse, txn);
	}
