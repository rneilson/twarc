...
class DBReader {
	...
	[_iter] (type, db, start, end, txn) {
		...
		if (type === 'keys') {
			...
			return valiter(this.indices.has(db));
		}
		else if (type === 'entries') {
			return entiter(this.indices.has(db));
		}
		else {
